...
<!--        Form View -->
<!--        <div class="card shadow-sm d-none" id="formView">-->
<!--            <div class="card-header bg-white d-flex justify-content-between align-items-center py-3">-->
<!--                <h5 class="mb-0 fw-semibold" id="formTitle">Novo Usuário</h5>-->
...
<!--                        <textarea class="form-control" id="userBio" rows="4" placeholder="Digite uma breve biografia"></textarea>-->
<!--                    </div>-->
<!--                    <hr>-->
